	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (BlockTools.isLockable(block)) {
			...
			if (!BIT.isPlayer(sPlayer)) {
				BITMessages.showError("You cant use this command in the console.");
				return false;
			} else if (BITPermissions.hasPerm(sPlayer, "digilock.create", BITPermissions.NOT_QUIET) || BITPermissions.hasPerm(sPlayer, "digilock.use", BITPermissions.NOT_QUIET) || BITPermissions.hasPerm(sPlayer, "digilock.admin", BITPermissions.NOT_QUIET) || BITPermissions.hasPerm(sPlayer, "digilock.*", BITPermissions.NOT_QUIET) || BITPermissions.hasPerm(sPlayer, "*", BITPermissions.NOT_QUIET)) {
