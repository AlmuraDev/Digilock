...
public class BITDigiLock {
	 ...
	 * @param block	   The block of the DigiLock.
	 * @param pincode	 of the DigiLock. "fingerprint" or "" or a 10 digits code.
	 * @param owner	   is the owner of the DigiLock
	 * @param closetimer  is number of seconds before the door closes.
	 * @param coowners	is the list of co - owners of the DigiLock.
