...
public class BITBackpackAPI {
	 ...
	 * @param player The player you want to get the inventory.
	 ...
	 * @param player	The player you want to set the inventory.
	 * @param inventory The SpoutBackpack inventory of this player.
	 */
