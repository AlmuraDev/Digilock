...
import dk.gabriel333.digilock.gui.LockButton;
...
public class LockCore {
	...
	public static void setPincode(SpoutPlayer sPlayer, SpoutBlock sBlock) {
		...
		if (BlockTools.isLocked(sBlock)) {
			...
			closetimerGUI.get(id).setText(Config.DIGILOCK_DefCloseTimer);
			//cost = Config.SBP_price18;
