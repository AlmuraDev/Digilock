package dk.gabriel333.register.payment;
...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new dk.gabriel333.register.payment.methods.iCo6());
        addMethod("iConomy", new dk.gabriel333.register.payment.methods.iCo5());
        addMethod("iConomy", new dk.gabriel333.register.payment.methods.iCo4());
        addMethod("BOSEconomy", new dk.gabriel333.register.payment.methods.BOSE6());
        addMethod("BOSEconomy", new dk.gabriel333.register.payment.methods.BOSE7());
        addMethod("Essentials", new dk.gabriel333.register.payment.methods.EE17());
        addMethod("Currency", new dk.gabriel333.register.payment.methods.MCUR());
